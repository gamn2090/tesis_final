...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<div id="sidebar">
		...
		<td rowspan="3" width="750px" height="430" valign="top" id="cuerpo"> <!-- Columna 2-->
			<h3>Bienvenido</h3>
<p align="justify" style="line-height : 20px;">El Sistema Integral de Control de Estudios de la Universidad de Oriente SICEUDO, tiene como objetivo principal prestar apoyo en la labores del día a día del Departamento de Admisión y Control de Estudios DACE, en cuanto a las actividades de admisión de estudiantes, la prosecución de estudiantes regulares y los egresados. En este portal web dirigido a los estudiantes regulares, se podrá registrar su inscripción regular, consultar e imprimir sus reportes académicos, entre otras solicitudes.</p>
<br>
<h3>Inscripción de Estudiantes Regulares</h3>
	<p align="justify" style="line-height : 20px;">Una vez iniciado el proceso de inscripción del período académico actual, el estudiante podrá inscribirse desde cualquier computador con conexión a internet, inclusive fuera del campus universitario. Para ello, primero debe conocer la fecha y hora asignada en su cita para registrar la inscripción. Si aún desconoce como inscribirse puede descargar el siguiente archivo: <a href="#" target="_blank">Instructivo de Inscripciones</a>.</p>
<br>
